...
class Metaclass_MoveBase_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'la_msgs.action.MoveBase_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveBase_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'la_msgs.action.MoveBase_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveBase_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from la_msgs.action import MoveBase
...
class MoveBase_SendGoal_Request(metaclass=Metaclass_MoveBase_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'la_msgs/MoveBase_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['la_msgs', 'action'], 'MoveBase_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from la_msgs.action._move_base import MoveBase_Goal
...
class Metaclass_MoveBase_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'la_msgs.action.MoveBase_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from la_msgs.action import _move_base
...
class MoveBase_SendGoal(metaclass=Metaclass_MoveBase_SendGoal):
    from la_msgs.action._move_base import MoveBase_SendGoal_Request as Request
    from la_msgs.action._move_base import MoveBase_SendGoal_Response as Response
...
class MoveBase_GetResult_Response(metaclass=Metaclass_MoveBase_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'la_msgs/MoveBase_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['la_msgs', 'action'], 'MoveBase_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from la_msgs.action._move_base import MoveBase_Result
...
class Metaclass_MoveBase_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'la_msgs.action.MoveBase_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveBase_GetResult(metaclass=Metaclass_MoveBase_GetResult):
    from la_msgs.action._move_base import MoveBase_GetResult_Request as Request
    from la_msgs.action._move_base import MoveBase_GetResult_Response as Response
...
class Metaclass_MoveBase_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'la_msgs.action.MoveBase_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveBase_FeedbackMessage(metaclass=Metaclass_MoveBase_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'la_msgs/MoveBase_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['la_msgs', 'action'], 'MoveBase_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from la_msgs.action._move_base import MoveBase_Feedback
...
class MoveBase(metaclass=Metaclass_MoveBase):
    ...
    from la_msgs.action._move_base import MoveBase_Goal as Goal
    # The result message defined in the action definition.
    from la_msgs.action._move_base import MoveBase_Result as Result
    # The feedback message defined in the action definition.
    from la_msgs.action._move_base import MoveBase_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from la_msgs.action._move_base import MoveBase_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from la_msgs.action._move_base import MoveBase_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from la_msgs.action._move_base import MoveBase_FeedbackMessage as FeedbackMessage
