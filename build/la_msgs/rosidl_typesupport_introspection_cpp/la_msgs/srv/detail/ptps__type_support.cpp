...
void fetch_function__Ptps_Response__blue_points(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::PointStamped *>(
    get_const_function__Ptps_Response__blue_points(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::PointStamped *>(untyped_value);
  value = item;
}

void assign_function__Ptps_Response__blue_points(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::PointStamped *>(
    get_function__Ptps_Response__blue_points(untyped_member, index));
  const auto & value = *reinterpret_cast<const geometry_msgs::msg::PointStamped *>(untyped_value);
  item = value;
}
...
void fetch_function__Ptps_Response__yellow_points(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::PointStamped *>(
    get_const_function__Ptps_Response__yellow_points(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::PointStamped *>(untyped_value);
  value = item;
}

void assign_function__Ptps_Response__yellow_points(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::PointStamped *>(
    get_function__Ptps_Response__yellow_points(untyped_member, index));
  const auto & value = *reinterpret_cast<const geometry_msgs::msg::PointStamped *>(untyped_value);
  item = value;
}
...
void fetch_function__Ptps_Response__green_points(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::PointStamped *>(
    get_const_function__Ptps_Response__green_points(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::PointStamped *>(untyped_value);
  value = item;
}

void assign_function__Ptps_Response__green_points(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::PointStamped *>(
    get_function__Ptps_Response__green_points(untyped_member, index));
  const auto & value = *reinterpret_cast<const geometry_msgs::msg::PointStamped *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Ptps_Response_message_member_array[8] = {
  ...
  },
  {
    ...
    fetch_function__Ptps_Response__red_points,  // fetch(index, &value) function pointer
    assign_function__Ptps_Response__red_points,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__Ptps_Response__blue_points,  // fetch(index, &value) function pointer
    assign_function__Ptps_Response__blue_points,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__Ptps_Response__yellow_points,  // fetch(index, &value) function pointer
    assign_function__Ptps_Response__yellow_points,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__Ptps_Response__green_points,  // fetch(index, &value) function pointer
    assign_function__Ptps_Response__green_points,  // assign(index, value) function pointer
