  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = la_msgs__srv__Ptps_Request;
    is_plain =
      (
...
static size_t _Ptps_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_la_msgs__srv__Ptps_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs__srv__Ptps_Response;
    is_plain =
      (
...
static size_t _Ptps_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_la_msgs__srv__Ptps_Response(
    full_bounded, is_plain, 0);
