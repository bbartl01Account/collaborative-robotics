  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = la_msgs__action__MoveBase_Goal;
    is_plain =
      (
...
static size_t _MoveBase_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_la_msgs__action__MoveBase_Goal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs__action__MoveBase_Result;
    is_plain =
      (
...
static size_t _MoveBase_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_la_msgs__action__MoveBase_Result(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs__action__MoveBase_Feedback;
    is_plain =
      (
...
static size_t _MoveBase_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_la_msgs__action__MoveBase_Feedback(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs__action__MoveBase_SendGoal_Request;
    is_plain =
      (
...
static size_t _MoveBase_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_la_msgs__action__MoveBase_SendGoal_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs__action__MoveBase_SendGoal_Response;
    is_plain =
      (
...
static size_t _MoveBase_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_la_msgs__action__MoveBase_SendGoal_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs__action__MoveBase_GetResult_Request;
    is_plain =
      (
...
static size_t _MoveBase_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_la_msgs__action__MoveBase_GetResult_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs__action__MoveBase_GetResult_Response;
    is_plain =
      (
...
static size_t _MoveBase_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_la_msgs__action__MoveBase_GetResult_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs__action__MoveBase_FeedbackMessage;
    is_plain =
      (
...
static size_t _MoveBase_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_la_msgs__action__MoveBase_FeedbackMessage(
    full_bounded, is_plain, 0);
