...
la_msgs__action__MoveBase_Goal__create()
{
  ...
  la_msgs__action__MoveBase_Goal * msg = (la_msgs__action__MoveBase_Goal *)allocator.allocate(sizeof(la_msgs__action__MoveBase_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
la_msgs__action__MoveBase_Goal__Sequence__init(la_msgs__action__MoveBase_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (la_msgs__action__MoveBase_Goal *)allocator.zero_allocate(size, sizeof(la_msgs__action__MoveBase_Goal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_Goal__Sequence * array = (la_msgs__action__MoveBase_Goal__Sequence *)allocator.allocate(sizeof(la_msgs__action__MoveBase_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  la_msgs__action__MoveBase_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    la_msgs__action__MoveBase_Goal * data =
      (la_msgs__action__MoveBase_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!la_msgs__action__MoveBase_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          la_msgs__action__MoveBase_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_Result * msg = (la_msgs__action__MoveBase_Result *)allocator.allocate(sizeof(la_msgs__action__MoveBase_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
...
la_msgs__action__MoveBase_Result__Sequence__init(la_msgs__action__MoveBase_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (la_msgs__action__MoveBase_Result *)allocator.zero_allocate(size, sizeof(la_msgs__action__MoveBase_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_Result__Sequence * array = (la_msgs__action__MoveBase_Result__Sequence *)allocator.allocate(sizeof(la_msgs__action__MoveBase_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  la_msgs__action__MoveBase_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    la_msgs__action__MoveBase_Result * data =
      (la_msgs__action__MoveBase_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!la_msgs__action__MoveBase_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          la_msgs__action__MoveBase_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_Feedback * msg = (la_msgs__action__MoveBase_Feedback *)allocator.allocate(sizeof(la_msgs__action__MoveBase_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
...
la_msgs__action__MoveBase_Feedback__Sequence__init(la_msgs__action__MoveBase_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (la_msgs__action__MoveBase_Feedback *)allocator.zero_allocate(size, sizeof(la_msgs__action__MoveBase_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_Feedback__Sequence * array = (la_msgs__action__MoveBase_Feedback__Sequence *)allocator.allocate(sizeof(la_msgs__action__MoveBase_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  la_msgs__action__MoveBase_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    la_msgs__action__MoveBase_Feedback * data =
      (la_msgs__action__MoveBase_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!la_msgs__action__MoveBase_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          la_msgs__action__MoveBase_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_SendGoal_Request * msg = (la_msgs__action__MoveBase_SendGoal_Request *)allocator.allocate(sizeof(la_msgs__action__MoveBase_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
la_msgs__action__MoveBase_SendGoal_Request__Sequence__init(la_msgs__action__MoveBase_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (la_msgs__action__MoveBase_SendGoal_Request *)allocator.zero_allocate(size, sizeof(la_msgs__action__MoveBase_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_SendGoal_Request__Sequence * array = (la_msgs__action__MoveBase_SendGoal_Request__Sequence *)allocator.allocate(sizeof(la_msgs__action__MoveBase_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  la_msgs__action__MoveBase_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    la_msgs__action__MoveBase_SendGoal_Request * data =
      (la_msgs__action__MoveBase_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!la_msgs__action__MoveBase_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          la_msgs__action__MoveBase_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_SendGoal_Response * msg = (la_msgs__action__MoveBase_SendGoal_Response *)allocator.allocate(sizeof(la_msgs__action__MoveBase_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
la_msgs__action__MoveBase_SendGoal_Response__Sequence__init(la_msgs__action__MoveBase_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (la_msgs__action__MoveBase_SendGoal_Response *)allocator.zero_allocate(size, sizeof(la_msgs__action__MoveBase_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_SendGoal_Response__Sequence * array = (la_msgs__action__MoveBase_SendGoal_Response__Sequence *)allocator.allocate(sizeof(la_msgs__action__MoveBase_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  la_msgs__action__MoveBase_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    la_msgs__action__MoveBase_SendGoal_Response * data =
      (la_msgs__action__MoveBase_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!la_msgs__action__MoveBase_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          la_msgs__action__MoveBase_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_GetResult_Request * msg = (la_msgs__action__MoveBase_GetResult_Request *)allocator.allocate(sizeof(la_msgs__action__MoveBase_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
la_msgs__action__MoveBase_GetResult_Request__Sequence__init(la_msgs__action__MoveBase_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (la_msgs__action__MoveBase_GetResult_Request *)allocator.zero_allocate(size, sizeof(la_msgs__action__MoveBase_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_GetResult_Request__Sequence * array = (la_msgs__action__MoveBase_GetResult_Request__Sequence *)allocator.allocate(sizeof(la_msgs__action__MoveBase_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  la_msgs__action__MoveBase_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    la_msgs__action__MoveBase_GetResult_Request * data =
      (la_msgs__action__MoveBase_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!la_msgs__action__MoveBase_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          la_msgs__action__MoveBase_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_GetResult_Response * msg = (la_msgs__action__MoveBase_GetResult_Response *)allocator.allocate(sizeof(la_msgs__action__MoveBase_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
la_msgs__action__MoveBase_GetResult_Response__Sequence__init(la_msgs__action__MoveBase_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (la_msgs__action__MoveBase_GetResult_Response *)allocator.zero_allocate(size, sizeof(la_msgs__action__MoveBase_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_GetResult_Response__Sequence * array = (la_msgs__action__MoveBase_GetResult_Response__Sequence *)allocator.allocate(sizeof(la_msgs__action__MoveBase_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  la_msgs__action__MoveBase_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    la_msgs__action__MoveBase_GetResult_Response * data =
      (la_msgs__action__MoveBase_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!la_msgs__action__MoveBase_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          la_msgs__action__MoveBase_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_FeedbackMessage * msg = (la_msgs__action__MoveBase_FeedbackMessage *)allocator.allocate(sizeof(la_msgs__action__MoveBase_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
la_msgs__action__MoveBase_FeedbackMessage__Sequence__init(la_msgs__action__MoveBase_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (la_msgs__action__MoveBase_FeedbackMessage *)allocator.zero_allocate(size, sizeof(la_msgs__action__MoveBase_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  la_msgs__action__MoveBase_FeedbackMessage__Sequence * array = (la_msgs__action__MoveBase_FeedbackMessage__Sequence *)allocator.allocate(sizeof(la_msgs__action__MoveBase_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  la_msgs__action__MoveBase_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    la_msgs__action__MoveBase_FeedbackMessage * data =
      (la_msgs__action__MoveBase_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!la_msgs__action__MoveBase_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          la_msgs__action__MoveBase_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
