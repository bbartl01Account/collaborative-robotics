...
#include "la_msgs/action/detail/move_base__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const la_msgs::action::MoveBase_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  la_msgs::action::MoveBase_Goal & ros_message)
{
  // Member: target_pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = la_msgs::action::MoveBase_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const la_msgs::action::MoveBase_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<la_msgs::action::MoveBase_Goal *>(
    untyped_ros_message);
...
{
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, la_msgs, action, MoveBase_Goal)() {
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_la_msgs
cdr_serialize(
  const la_msgs::action::MoveBase_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: done
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  la_msgs::action::MoveBase_Result & ros_message)
{
  // Member: done
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs::action::MoveBase_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const la_msgs::action::MoveBase_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<la_msgs::action::MoveBase_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, la_msgs, action, MoveBase_Result)() {
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_la_msgs
cdr_serialize(
  const la_msgs::action::MoveBase_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: distance
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  la_msgs::action::MoveBase_Feedback & ros_message)
{
  // Member: distance
  cdr >> ros_message.distance;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs::action::MoveBase_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const la_msgs::action::MoveBase_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<la_msgs::action::MoveBase_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, la_msgs, action, MoveBase_Feedback)() {
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_Feedback__handle;
}
...
// functions for la_msgs::action::MoveBase_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_la_msgs
cdr_serialize(
  const la_msgs::action::MoveBase_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  la_msgs::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  la_msgs::action::MoveBase_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  la_msgs::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    la_msgs::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        la_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_MoveBase_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs::action::MoveBase_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const la_msgs::action::MoveBase_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<la_msgs::action::MoveBase_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, la_msgs, action, MoveBase_SendGoal_Request)() {
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_la_msgs
cdr_serialize(
  const la_msgs::action::MoveBase_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  la_msgs::action::MoveBase_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs::action::MoveBase_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const la_msgs::action::MoveBase_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<la_msgs::action::MoveBase_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, la_msgs, action, MoveBase_SendGoal_Response)() {
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_SendGoal_Response__handle;
}
...
{
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, la_msgs, action, MoveBase_SendGoal)() {
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_la_msgs
cdr_serialize(
  const la_msgs::action::MoveBase_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  la_msgs::action::MoveBase_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs::action::MoveBase_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const la_msgs::action::MoveBase_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<la_msgs::action::MoveBase_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, la_msgs, action, MoveBase_GetResult_Request)() {
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for la_msgs::action::MoveBase_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_la_msgs
cdr_serialize(
  const la_msgs::action::MoveBase_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  la_msgs::action::MoveBase_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        la_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_MoveBase_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs::action::MoveBase_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const la_msgs::action::MoveBase_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<la_msgs::action::MoveBase_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, la_msgs, action, MoveBase_GetResult_Response)() {
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_GetResult_Response__handle;
}
...
{
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, la_msgs, action, MoveBase_GetResult)() {
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_GetResult__handle;
}
...
// functions for la_msgs::action::MoveBase_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_la_msgs
cdr_serialize(
  const la_msgs::action::MoveBase_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  la_msgs::action::MoveBase_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        la_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_MoveBase_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = la_msgs::action::MoveBase_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const la_msgs::action::MoveBase_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<la_msgs::action::MoveBase_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, la_msgs, action, MoveBase_FeedbackMessage)() {
  return &la_msgs::action::typesupport_fastrtps_cpp::_MoveBase_FeedbackMessage__handle;
}
