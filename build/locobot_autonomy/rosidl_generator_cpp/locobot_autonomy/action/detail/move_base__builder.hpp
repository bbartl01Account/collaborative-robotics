...
class Init_MoveBase_Goal_control_base_angle_bool
{
public:
  explicit Init_MoveBase_Goal_control_base_angle_bool(::locobot_autonomy::action::MoveBase_Goal & msg)
  : msg_(msg)
  {}
  ::locobot_autonomy::action::MoveBase_Goal control_base_angle_bool(::locobot_autonomy::action::MoveBase_Goal::_control_base_angle_bool_type arg)
  {
    msg_.control_base_angle_bool = std::move(arg);
...
public:
  ...
  {}
  Init_MoveBase_Goal_control_base_angle_bool target_pose(::locobot_autonomy::action::MoveBase_Goal::_target_pose_type arg)
  {
    msg_.target_pose = std::move(arg);
    return Init_MoveBase_Goal_control_base_angle_bool(msg_);
  }
...
class Init_MoveBase_Feedback_angular_distance
{
public:
  explicit Init_MoveBase_Feedback_angular_distance(::locobot_autonomy::action::MoveBase_Feedback & msg)
  : msg_(msg)
  {}
  ::locobot_autonomy::action::MoveBase_Feedback angular_distance(::locobot_autonomy::action::MoveBase_Feedback::_angular_distance_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_MoveBase_Feedback_angular_distance distance(::locobot_autonomy::action::MoveBase_Feedback::_distance_type arg)
  {
    msg_.distance = std::move(arg);
    return Init_MoveBase_Feedback_angular_distance(msg_);
  }
